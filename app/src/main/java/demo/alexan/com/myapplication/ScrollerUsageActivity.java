...
public class ScrollerUsageActivity extends Activity {
    private static final String TAG = "ScrollerUsageActivity";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        lay0.setBackgroundColor(this.getResources().getColor(android.R.color.holo_red_dark));
